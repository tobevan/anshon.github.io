# AndroidStudio FFmpeg 集成



## linux环境下交叉编译Android arm静态库

1.下载r17c  https://dl.google.com/android/repository/android-ndk-r17c-linux-x86_64.zip?hl=zh_cn

2.配置环境变量 vim /etc/profile，然后输入ndk-build验证
...
/root/android-ndk-r17c/build/core/build-local.mk:151: *** Android NDK: Aborting    .  Stop.
```

3.下载ffmpeg  4.0.6版本   https://ffmpeg.org/releases/ffmpeg-4.0.6.tar.bz2

运行配置文件 ./configure --disable-x86asm
